...
const links = [
  ...
  { to: "/floorplan", label: "Floor Plan", icon: "M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zm0 9.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zm0 9.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" },
  { to: "/automations", label: "Automations", icon: "M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z" },
  { to: "/gestures", label: "Gestures", icon: "M10.05 4.575a1.575 1.575 0 10-3.15 0v3.15H3.75a1.575 1.575 0 000 3.15h3.15v3.15a1.575 1.575 0 003.15 0v-3.15h3.15a1.575 1.575 0 000-3.15h-3.15v-3.15zM15 12.75a3.75 3.75 0 110 7.5 3.75 3.75 0 010-7.5z" },
  { to: "/camera-gestures", label: "Camera Gestures", icon: "M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25h-9A2.25 2.25 0 002.25 7.5v9a2.25 2.25 0 002.25 2.25z" },
  { to: "/lighting", label: "Lighting", icon: "M12 2.25a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75zm6.894 2.856a.75.75 0 010 1.06l-1.061 1.061a.75.75 0 11-1.06-1.06l1.06-1.061a.75.75 0 011.061 0zM21.75 12a.75.75 0 01-.75.75h-1.5a.75.75 0 010-1.5H21a.75.75 0 01.75.75zm-2.856 6.894a.75.75 0 01-1.06 0l-1.061-1.061a.75.75 0 111.06-1.06l1.061 1.06a.75.75 0 010 1.061zM12 18.75a.75.75 0 01.75.75V21a.75.75 0 01-1.5 0v-1.5a.75.75 0 01.75-.75zm-4.773-1.977a.75.75 0 010 1.06l-1.06 1.061a.75.75 0 11-1.061-1.06l1.06-1.061a.75.75 0 011.061 0zM5.25 12a.75.75 0 01-.75.75H3a.75.75 0 010-1.5h1.5a.75.75 0 01.75.75zm1.977-5.833a.75.75 0 01-1.06 1.06L5.106 6.166a.75.75 0 011.06-1.06l1.061 1.06zM12 7.5a4.5 4.5 0 100 9 4.5 4.5 0 000-9z" },
